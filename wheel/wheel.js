...
const prizes = [
    ...
    { emoji: "🎨", title: "Unlimited Art Supplies!", text: "Endless sketchbooks, markers and paints for every idea in your head." },
    { emoji: "⚡", title: "El's Powers!", text: "The strength to flip any tough day upside down, just like Eleven." },
    { emoji: "🎧",  title: "Running Up That Hill, On Loop!", text: "One year of unlimited replays, no skips allowed." },
    { emoji: "💃", title: "Dance Party!",       text: "You've won an imaginary dance party, just for you." },
    { emoji: "👓", title: "The Cutest Specs Upgrade", text: "May your next pair of glasses be even more you." },
    { emoji: "🩷", title: "A Virtual Rose",     text: "A pink rose, freshly picked from the internet, just for you." },
    { emoji: "😄", title: "A Day of Laughter",  text: "May today be filled with laughter that makes your cheeks hurt." }
];

const colors = ["#ff2d87", "#ff8fbc"];
...
prizes.forEach((prize, i) => {
    ...
    svgMarkup += `<path d="M${cx},${cy} L${start.x},${start.y} A${r},${r} 0 ${largeArc},1 ${end.x},${end.y} Z" fill="${colors[i % 2]}" stroke="#fff" stroke-width="2"/>`;
